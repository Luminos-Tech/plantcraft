...
import { AlertTriangle, CheckCircle2, Droplets, Leaf, Send, Skull, Sparkles } from 'lucide-react'
...
export function PlantCard({ plant, compact = false, selected = false, className, onSelect }: PlantCardProps) {
  ...
  return (
    <div className={cn(
      'card-hover pixel-shadow group w-full overflow-hidden rounded-lg border-2 bg-card/95 p-3',
      !compact && 'sm:p-4',
    ...
    onClick={onSelect}
    >
      <div className={cn('flex gap-3', !compact && 'sm:gap-4')}>
        {/* Plant Thumbnail */}
        <div className={cn(
